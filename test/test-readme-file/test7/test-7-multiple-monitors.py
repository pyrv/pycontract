...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files('test-7-multiple-monitors.Monitor1.test.pu', 'test-7-multiple-monitors.Monitor1.test.pu')
        self.assert_equal_files('test-7-multiple-monitors.Monitor2.test.pu', 'test-7-multiple-monitors.Monitor2.test.pu')
        self.assert_equal_files('test-7-multiple-monitors.Monitors.test.pu', 'test-7-multiple-monitors.Monitors.test.pu')
