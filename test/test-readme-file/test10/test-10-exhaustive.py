...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files('test-10-exhaustive.Obligations1.test.pu', 'test-10-exhaustive.Obligations1.pu')
        self.assert_equal_files('test-10-exhaustive.Obligations2.test.pu', 'test-10-exhaustive.Obligations2.pu')
        self.assert_equal_files('test-10-exhaustive.Obligations3.test.pu', 'test-10-exhaustive.Obligations3.pu')
