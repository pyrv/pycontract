...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files('test-8-indexing.LockMonitor.test.pu', 'test-8-indexing.LockMonitor.pu')
        self.assert_equal_files('test-8-indexing.AcquireRelease.test.pu', 'test-8-indexing.AcquireRelease.pu')
        self.assert_equal_files('test-8-indexing.PastAcquireRelease.test.pu', 'test-8-indexing.PastAcquireRelease.pu')
