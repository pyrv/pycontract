...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files(DIR + 'test_5_only_sideeffects.CommandExecution.test.pu', DIR + 'test_5_only_sideeffects.CommandExecution.pu')
...
class Test2(test.utest.Test):
    def test1(self):
        ...
        m.verify(trace)
        errors_expected = ['[VIOLATION] *** error in CommandExecution:\n    more completions than dispatches']
