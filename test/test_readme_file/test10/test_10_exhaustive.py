...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files(DIR + 'test_10_exhaustive.Obligations1.test.pu', DIR + 'test_10_exhaustive.Obligations1.pu')
        self.assert_equal_files(DIR + 'test_10_exhaustive.Obligations2.test.pu', DIR + 'test_10_exhaustive.Obligations2.pu')
        self.assert_equal_files(DIR + 'test_10_exhaustive.Obligations3.test.pu', DIR + 'test_10_exhaustive.Obligations3.pu')
...
class Test2(test.utest.Test):
    def test1(self):
        ...
        m.verify(trace)
        errors_expected = [
            "[HOT STATE] *** error at end in Obligations1:\n    terminates in hot state DoLog('TURN')"
        ]
