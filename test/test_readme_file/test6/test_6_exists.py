...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files(DIR + 'test_6_exists.PastAcquireRelease.test.pu', DIR + 'test_6_exists.PastAcquireRelease.pu')
        self.assert_equal_files(DIR + 'test_6_exists.FlexiblePastAcquireRelease.test.pu', DIR + 'test_6_exists.FlexiblePastAcquireRelease.pu')
