...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files(DIR + 'test-6-exists.PastAcquireRelease.test.pu', DIR + 'test-6-exists.PastAcquireRelease.pu')
        self.assert_equal_files(DIR + 'test-6-exists.FlexiblePastAcquireRelease.test.pu', DIR + 'test-6-exists.FlexiblePastAcquireRelease.pu')
