...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files(DIR + 'test-1-locks.AcquireRelease.test.pu', DIR + 'test-1-locks.AcquireRelease.pu')
        self.assert_equal_files(DIR + 'test-1-locks.ConditionedAcquireRelease.test.pu', DIR + 'test-1-locks.ConditionedAcquireRelease.pu')
        self.assert_equal_files(DIR + 'test-1-locks.CountingAcquireRelease.test.pu', DIR + 'test-1-locks.CountingAcquireRelease.pu')
        self.assert_equal_files(DIR + 'test-1-locks.ShortAcquireRelease.test.pu', DIR + 'test-1-locks.ShortAcquireRelease.pu')
