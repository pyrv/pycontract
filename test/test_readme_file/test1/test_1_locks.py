...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files(DIR + 'test_1_locks.AcquireRelease.test.pu', DIR + 'test_1_locks.AcquireRelease.pu')
        self.assert_equal_files(DIR + 'test_1_locks.ConditionedAcquireRelease.test.pu', DIR + 'test_1_locks.ConditionedAcquireRelease.pu')
        self.assert_equal_files(DIR + 'test_1_locks.CountingAcquireRelease.test.pu', DIR + 'test_1_locks.CountingAcquireRelease.pu')
        self.assert_equal_files(DIR + 'test_1_locks.ShortAcquireRelease.test.pu', DIR + 'test_1_locks.ShortAcquireRelease.pu')
