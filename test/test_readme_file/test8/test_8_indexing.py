...
class Test1(test.utest.Test):
    def test1(self):
        ...
        self.assert_equal_files(DIR + 'test_8_indexing.LockMonitor.test.pu', DIR + 'test_8_indexing.LockMonitor.pu')
        self.assert_equal_files(DIR + 'test_8_indexing.AcquireRelease.test.pu', DIR + 'test_8_indexing.AcquireRelease.pu')
        self.assert_equal_files(DIR + 'test_8_indexing.PastAcquireRelease.test.pu', DIR + 'test_8_indexing.PastAcquireRelease.pu')
...
class Test2(test.utest.Test):
    def test1(self):
        ...
        errors_expected = [
            ...
            "[HOT STATE] *** error at end in PastAcquireRelease:\n    terminates in hot state Locked('wheel', 12)"]
